...
echo -e "/var/log/restcomm2" > /etc/container_environment/RESTCOMM_LOGS
...
echo -e "FALSE" > /etc/container_environment/USE_STANDARD_SIP_PORTS
...
echo -e "5083" > /etc/container_environment/LB_INTERNAL_PORT
