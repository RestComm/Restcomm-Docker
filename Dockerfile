...
RUN wget -qc  https://mobicents.ci.cloudbees.com/job/RestComm/832/artifact/Restcomm-JBoss-AS7-`wget -qO- https://mobicents.ci.cloudbees.com/job/RestComm/832/artifact/restcomm-version.txt | cat`.zip -O- | bsdtar -xvf - -C /opt/ && mv /opt/Restcomm-JBoss-AS7-*/ /opt/Restcomm-JBoss-AS7/

RUN wget -qO- https://mobicents.ci.cloudbees.com/job/RestComm/832/artifact/restcomm-version.txt | cat > /tmp/version
