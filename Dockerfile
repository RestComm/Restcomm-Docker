...
RUN wget -qc https://mobicents.ci.cloudbees.com/view/RestComm/job/RestComm/925/artifact/Restcomm-JBoss-AS7-7.7.0.925.zip -O- | bsdtar -xvf - -C /opt/ && mv /opt/Restcomm-JBoss-AS7-*/ ${install_dir} && wget -qO- https://mobicents.ci.cloudbees.com/job/RestComm/879/artifact/restcomm-version.txt -O ${install_dir}/version.txt && cp ${install_dir}/version.txt /tmp/version
