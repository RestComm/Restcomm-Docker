...
RUN wget -qO- https://mobicents.ci.cloudbees.com/job/RestComm-For-Specific-Branch-No-Test/lastSuccessfulBuild/artifact/restcomm-version.txt -O version.txt && mv version.txt /tmp/version
RUN wget -qc https://mobicents.ci.cloudbees.com/job/RestComm-For-Specific-Branch-No-Test/lastSuccessfulBuild/artifact/Restcomm-JBoss-AS7-`cat /tmp/version`.zip -O Restcomm-JBoss-AS7.zip && \
