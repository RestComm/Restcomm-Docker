...
RUN wget -qc https://mobicents.ci.cloudbees.com/job/RestComm/800/artifact/Restcomm-JBoss-AS7-7.5.0.800.zip -O- | bsdtar -xvf - -C /opt/ && mv /opt/Restcomm-JBoss-AS7-*/ /opt/Restcomm-JBoss-AS7/
