...
RUN wget -qO- https://mobicents.ci.cloudbees.com/job/RestComm/1111/artifact/restcomm-version.txt -O version.txt && mv version.txt /tmp/version
RUN wget -qc  https://mobicents.ci.cloudbees.com/job/RestComm/1111/artifact/Restcomm-JBoss-AS7-8.0.0.1111.zip -O Restcomm-JBoss-AS7.zip && \
