...
ADD ./scripts/populate-update-mysqldb.sh ${install_dir}/bin/restcomm/populate-update-mysqldb.sh
ADD ./scripts/create-mysql-datasource.sh ${install_dir}/bin/restcomm/autoconfig.d/create-mysql-datasource.sh
ADD ./scripts/reconfigure-mysqldb.sh ${install_dir}/bin/restcomm/autoconfig.d/reconfigure-mysqldb.sh
ADD ./ca-startcom.der ${install_dir}/ca-startcom.der
